...
f_dir1 <- "/Users/lucasliu/Desktop/DrChen_Projects/ROD_Project/Intermediate_Data/0103_21/out1/"
...
data_input$Starting_CASCOREA_LABEL <- Label_df[match(rownames(Label_df),rownames(data_input)),"Starting_CASCOREA_LABEL"]
...
for (f in 1:length(critical_features)){
  ...
  voilin_plot_data$Starting_SqRtVOLUME_LABEL[grp0_idex] <- "(0) start non-high \n"
  voilin_plot_data$Starting_SqRtVOLUME_LABEL[grp1_idex] <- "(1) start high \n"
